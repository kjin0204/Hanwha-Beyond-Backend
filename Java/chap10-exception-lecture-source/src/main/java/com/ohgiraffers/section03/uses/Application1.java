...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 수업목표. 예외처리를 많이 사용하는 ioㅐ키지와 관련된 try-catch 구문을 이해할 수 있다. */
        /* 설명.
         *  예외 처리를 가장 만이 사용하게 되는 상황(io ㅐ키지 관련)에서 try-catch 구문을 실제 살황과
         *  유사하게 사용해 보자.
        ...
        * */
        ...
        try {
            ...
            /* 설명.
             *  예외처리 구문과 상관없이 반드시 수행해야하는 경우 finally에 작성하는데
             *  보통 사용한 자원(resouce)를 반납하는 용도로 사용하게 된다.
            * */
