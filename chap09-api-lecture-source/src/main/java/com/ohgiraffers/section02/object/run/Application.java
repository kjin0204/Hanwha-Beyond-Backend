package com.ohgiraffers.section02.object.run;

import com.ohgiraffers.section02.object.DTO.BookDTO;
...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("두 인스턴스를 hashCode() 메소드로 비교 : " + (book1.hashCode() == book2.hashCode()));

        /* 설명. 동등 비교를 위한 equals()로 재정의 하고 싶다. */
        /* 설명.
         *  동등 빅는 객체들이 가진 필드에서 우리가 선택한 기준의 필드 값이 같으면 true가 나오도록
