...
public class Application {
    public static void main(String[] args) {
        ...
        /* 목차. 1. 기본잘형을 매개변수로 전달 받는 매소드 호출 */
        int num = 20;
        System.out.println("call by value 전: " + num);
        pt.testPrimitiveTypeParameter(num);
        System.out.println("call by value 후: " + num);

        /* 목차. 2. 기본자료형 배열을 매개변수로 전달 받는 매소드 호출 */
        int[] iArr = new int[]{1, 2, 3, 4, 5};
        System.out.println("iArr 호출 전 = " + Arrays.toString(iArr));
        pt.testPrimitiveArrayTypeParameter(iArr);
        System.out.println("iArr 호출 후 = " + Arrays.toString(iArr));
        ...
        pt.testVariableLengthArrayParameter(new String[]{"강감찬1","낚시2","독서3"});
