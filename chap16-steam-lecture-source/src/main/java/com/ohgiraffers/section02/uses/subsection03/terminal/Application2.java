 ...
 * 설명.
 *   reduce()의 3가지 형태
 *  1. parma: optional 반환(빈 스트림 고려)
 *  2. param: 초기값 사용, 직접 값 변환
 *  3. param: 병렬 처리 가능
 * */
...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println("최종 결과 = " + reduceOneParam.orElse(0)); //15
        ...
        System.out.println("최종 결과 = " + reduceTwoParam); // 115

        /* 설명. 3. 병렬 처리용 reduce: 1개의 초기값, 1개의 누적용 람다식, 1개의 결합용 람다식 */
        /* 설명. 세 번쨰로 전달된 람다식은 병렬 스트림 일때만 활용하는 cpu의 여러 코어로 계산한 결과를 결합 할 용도의 람다식이다. */
//        Integer reduceTreeeParam = Stream.of(1, 2, 3, 4)
        Integer reduceTreeeParam = Stream.of(4, 5, 1, 2, 3, 9, 6, 7, 8, 10)
                .parallel() //병렬처리
                .reduce(0                 // 초기값은 parallel의 경우는 요소 갯수만큼 적용
                        , (a, b) -> {
        ...
        System.out.println("최종 결과 = " + reduceTreeeParam);
